...
from tg_bot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GBAN, MESSAGE_DUMP, spamwtc
...
GBAN_STATUS = CommandHandler(gbanstat, pass_args=True, filters=Filters.group)
